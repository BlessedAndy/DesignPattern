	...
	public static Object newProxyInstance(Class infce, InvocationHandler h) throws Exception { //JDK6 Complier API, CGLib, ASM
		...
		*/
		...
		String src = 
			...
			"    com.andy.designpattern.proxy.InvocationHandler h;" + rt +
							
			methodStr +
			"}";
		String fileName = 
			"e:/CodeTest/com/andy/designpattern/proxy/$Proxy1.java";
		...
		Class c = ul.loadClass("com.andy.designpattern.proxy.$Proxy1");
